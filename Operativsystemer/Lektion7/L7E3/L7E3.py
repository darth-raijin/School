...
class Context(LoggingMixIn, Operations):
    ...
    def getattr(self, path, fh=None):
        if path == "/":
         ...
         # TODO: If filename does not exist, raise exception: raise FuseOSError(ENOENT) TODO DONE
...
if __name__ == '__main__':
    ...
    # TODO: Establish mysql connection TODO DONE
    ...
    mycursor.execute(
        "CREATE TABLE file (fileid serial, filename VARCHAR(255), fileSize int, filecontent VARCHAR(255))")
